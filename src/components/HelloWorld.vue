    ...
    <v-row>
     <v-col v-for="n in 9" :key="n" cols="12" md="4">
      <v-hover v-slot="{ hover }">
        <v-card class="mx-auto rounded-xl" color="#37474F" dark max-width="400" >
          <v-card-title>
            ...
            <v-list-item-content>
              ...
              <v-list-item-title class="caption">02-10-2020</v-list-item-title>
            </v-list-item-content>
            <!-- <v-icon large>
              mdi-book-open-page-variant
            </v-icon> -->
            <!-- <span class="text-h6 font-weight-light">Tittle: </span> -->
          </v-card-title>
          ...
          <v-expand-transition>
            <div v-if="hover" color="#303F9F" class="d-flex transition-fast-in-fast-out darken-2 v-card--reveal text-h2 white--text" style="height: 100%;">
          ...
          <v-card-actions>
            <v-list-item class="grow">
              ...
              <v-row align="center" justify="end">
                ...
                <span class="subheading mr-2"> {{messages}} </span>
